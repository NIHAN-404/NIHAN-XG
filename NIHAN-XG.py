...
\033[38;5;46m│ \033[1;97m[\033[31;1m<>\033[1;97m] \033[33;1m𝘈𝘜𝘛𝘏𝘖𝘙      \033[1;97m  :  \033[34;1mNIHAN  \033[38;5;46m│ \033[33;1m│\033[38;5;46m\033[33;1m
\033[38;5;46m│ \033[1;97m[\033[31;1m<>\033[1;97m] \033[33;1m𝘎𝘐𝘛𝘏𝘜𝘉        \033[1;97m:  \033[34;1m NIHAN-XG      \033[38;5;46m   │  \033[33;1m
\033[38;5;46m│ \033[1;97m[\033[31;1m<>\033[1;97m] \033[33;1m𝘞𝘏𝘈𝘛𝘚𝘈𝘗𝘗   \033[1;97m   :  \033[34;1m+8801981002555       \033[38;5;46m│
\033[38;5;46m│ \033[1;97m[\033[31;1m<>\033[1;97m] \033[33;1m𝘗𝘖𝘞𝘌𝘙       \033[1;97m  :  \033[34;1mNIHAN-XG         \033[38;5;46m│
...
def Main():
	...
	if opt in ["B","2"]:
		admin()
	if opt in ["C","3"]:
		os.system('xdg-open https://www.facebook.com/profile.php?id=100089790850149&mibextid=ZbWKwL');time.sleep(1)
		fb()
	if opt in ["D","4"]:
...
def admin():
	...
	if bal =='1':
		...
		admin()
	if bal =='2':
		os.system('xdg-open https://https://www.facebook.com/profile.php?id=100089790850149&mibextid=ZbWKwL');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://github.com/NIHAN-404');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mNIHAN-XG-👿\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
...
def superuser():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/NIHAN-404/New/commit/556ab90da6fad8411e191a7d854d7304df6b7c14").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
